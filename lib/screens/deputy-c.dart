    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("ADMINISTRATIVE POSITIONS",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("INSTITUTIONS ATTENDED AND CERTIFICATES OBTAINED",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("ECUMENICAL AND EXTRA CHURCHES SERVICES",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
