    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("BAPTISM BY SPRINKLING",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text(" BAPTISM BY IMMERSION ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("SUITABLE TEXTS FOR SERMONS ON BAPTISM",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE PRAYER OF SANCTIFICATION ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            ...
            child: Text(
              ...
              "The Lord lift His countenance upon you and give you peace. Amen.(Num. 6:24-26) \n"
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("The prayer of Blessing",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE PRAYER OF CONSECRATION",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE PROMISE BY THE CONGREGATION",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("PRAYER OF SANCTIFICATION",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE AARONIC BLESSING",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("PRAYER OF DEDICATION",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            ...
            child: Text(
              ...
              "(Confirmands :) I DO\n \n"
              "Do you promise to contribute according to your ability with your strength, and money  towards the support of the Church, and to the furtherance of the gospel at home and abroad?"
              "(Confirmands :) I DO \n \n"
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("DECLARATION OF RECEPTION AND WELCOME ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("ON THE ADMINISTRATION OF THE LORD’S SUPPER  GENERAL ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("REVERENCE FOR THE LORD’S TABLE ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("PREPARING THE LORD’S TABLE",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("ADMINISTRATION THE LORD’S SUPPER",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("AN ORDER FOR A PREPARATORY SERVICE",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            ...
            child: Text(
              ...
              "Above all, with Your whole church throughout the world, we adore You for Your love in the  redemption of mankind by our Lord Jesus Christ; \n through whom we humbly offer unto You  our most hearty thanks and praise. We bless You for the descent of the Holy Spirit; for Your  Church filled with His Presence; for our baptism and nurture in the faith; and for the great  hope of everlasting life Especially at this time we praise You for the Sacrament whereby You feed our souls with the bread of life.\n"
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("Prayer of Thanksgiving for the Faithful Departed ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("A BRIEF ORDER FOR A PREPARATORY SERVICE",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("A TIME OF SELF-EXAMINATION ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text(
                "THE GREAT ORDER FOR THE ADMINISTRATION OF THE SACRAMENT OF THE LORD’S SUPPER \n \n"
                "THE APPROACH ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE ECUMENICAL INVITATION   ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE PRAYER OF THE VEIL",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE PRAYER OF OFFERING",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE EUCHARISTIC PRAYER",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE SACRAMENT OF THE LORD’S SUPPER ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("OUR LORD’S INVITATION ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE WARRANT (THE WORDS OF THE INSTITUTION)",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE PRELIMINARY EPICLESIS (SETTING APART)  ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE INTRODUCTORY DIALOGUE ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE THANKSGIVING FOR REDEMPTION",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE ANAMNESIS [REMEMBERING CHRIST WHO IS PRESENT] ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE FRACTION [CEREMONIAL BREAKING OF BREAD] ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("AND WITH YOUR SPIRIT",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("Prayer of Commemoration for the Faithful Departed",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("THE FRACTION AND DISTRIBUTION  ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
