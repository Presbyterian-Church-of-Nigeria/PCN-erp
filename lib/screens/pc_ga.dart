        ...
        Container(
          ...
          child: Text(
            ...
            style: TextStyle(
              ...
              fontFamily: 'Montserrat', fontSize: size - 1,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("APPOINTMENT/EMPLOYMENT STATUS:",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            ...
            child: Text(
              ...
              style: TextStyle(fontFamily: 'Montserrat', fontSize: size - 1),
            ),
          ),
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("UNIVERSITY/TERTIARY EDUCATION:",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("PRIMARY & SECONDARY EDUCATION",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text(" DETAILS OF PASTORAL EXPERIENCE:",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text(" DETAILS OF ECUMENICAL EXPERIENCE:",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("LEADERSHIP POSITIONS HELD",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("(2) Construction of Sanctuary and Manse ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("(3) Other Landmark Contributions   ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("(2) Membership of Learned Societies  ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("DETAILS OF TEACHING EXPERIENCE  ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("COMPUTER SOFTWARE SKILLS ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("(a) Books already published  ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("(b) Chapters in Books already published  ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("MAJOR CONFERENCES ATTENDED WITH PAPERS READ   ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("2. Prof. Emele Mba Uka  ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
          ...
          Container(
            padding: EdgeInsets.only(top: spacer),
            child: Text("3. Prof. Hendrik L. Bosman ",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Montserrat',
