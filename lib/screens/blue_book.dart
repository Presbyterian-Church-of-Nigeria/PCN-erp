    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Text(
              "THIS EDITION
    This edition of the Practice and Procedures is the product of a draft copy presented to the Board of Faith and Order early in 1988, which was revised by the Board and then presented to the General Assembly in August of 1988. The Assembly had copies sent to all the Presbyteries for study, and from the comments received by the Board a special meeting was held in June 1989 to incorporate such comments and suggestions as were consistent with the ideas of Presbyterian polity.

PROPOSED CONTENTS OF THE ENTIRE BOOK:
    This edition is laid out on the premise that there will be a total of three major sections to the Practice and Procedure. They will be:-\n
    Section “G" -- Form of Government\n
    Section “D” -- Book of Discipline\n
    Section “W" -- The Work and Worship of the Church.\n

    This edition covers only section “G” (Form of Government), although at certain points there are references to section “D" and “WH. The other two sections are still to come, and are in fact partially ready. Pages 70-94 of the old “P & P" will be enlarge and included in section “D” (Book of Discipline)"
